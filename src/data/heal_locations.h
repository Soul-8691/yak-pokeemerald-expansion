static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VARROCK_NORTH - 1] = {MAP_GROUP(VARROCK_NORTH), MAP_NUM(VARROCK_NORTH), 3, 10},
    [HEAL_LOCATION_BARBARIAN_VILLAGE - 1] = {MAP_GROUP(BARBARIAN_VILLAGE), MAP_NUM(BARBARIAN_VILLAGE), 9, 26},
    [HEAL_LOCATION_GOBLIN_VILLAGE - 1] = {MAP_GROUP(GOBLIN_VILLAGE), MAP_NUM(GOBLIN_VILLAGE), 19, 11},
    ...
    [HEAL_LOCATION_WILDERNESS_VOLCANO_LOBBY - 1] = {MAP_GROUP(WILDERNESS_VOLCANO_LOBBY), MAP_NUM(WILDERNESS_VOLCANO_LOBBY), 14, 6},
};
