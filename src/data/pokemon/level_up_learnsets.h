...
static const struct LevelUpMove sDemon_Lesser_Normal_FormLevelUpLearnset[] = {
LEVEL_UP_MOVE(1, MOVE_SCRATCH),
LEVEL_UP_MOVE(2, MOVE_SCREECH),
LEVEL_UP_MOVE(3, MOVE_HONE_CLAWS),
LEVEL_UP_MOVE(8, MOVE_BITE),
...
static const struct LevelUpMove sDemon_Greater_Normal_FormLevelUpLearnset[] = {
LEVEL_UP_MOVE(1, MOVE_SCRATCH),
LEVEL_UP_MOVE(2, MOVE_SCREECH),
LEVEL_UP_MOVE(3, MOVE_HONE_CLAWS),
LEVEL_UP_MOVE(8, MOVE_BITE),
...
static const struct LevelUpMove sBloodveld_Insatieable_mutated_FormLevelUpLearnset[] = {
LEVEL_UP_MOVE(1, MOVE_FIRE_FANG),
LEVEL_UP_MOVE(2, MOVE_ABSORB),
LEVEL_UP_MOVE(3, MOVE_GROWL),
LEVEL_UP_MOVE(6, MOVE_SCRATCH),
