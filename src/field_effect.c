...
static const u32 sNewGameBirch_Gfx[] = INCBIN_U32("graphics/oak_speech/oak.8bpp.lz");
static const u32 sUnusedBirchBeauty[] = INCBIN_U32("graphics/birch_speech/unused_beauty.4bpp");
static const u16 sNewGameBirch_Pal[] = INCBIN_U16("graphics/oak_speech/oak.gbapal");
