...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_GUTHBIRD] = BACK_ANIM_GROW_1,
    [SPECIES_GUTHRAPTOR] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_ZAMLING] = BACK_ANIM_H_SLIDE,
    [SPECIES_ZAMBIRD] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_ZAMOHAWK] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SARALING] = BACK_ANIM_H_SLIDE,
    [SPECIES_SARABIRD] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_SARAOWL] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CHICK] = BACK_ANIM_H_SLIDE,
    [SPECIES_CHICKEN_NORMAL_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_DREADFOWL] = BACK_ANIM_GROW_1,
    [SPECIES_CHICKEN_VARROCK_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_CHICKEN_DIVING_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CHICKEN_KARAMJA_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_CHICKEN_DEATH_FORM] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CHICKEN_BANDOSIAN_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CHICKEN_WAR_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_ROOSTER_NORMAL_FORM] = BACK_ANIM_H_SLIDE,
    [SPECIES_ERNEST] = BACK_ANIM_V_SHAKE_WITH_PAUSE,
    [SPECIES_ROOSTER_KARAMJA_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_OOMLIE] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ROOSTER_BANDOSIAN_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CHICKEN_FAMINE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_ROOSTER_VARROCK_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CHICKEN_PESTILENCE_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_CHICKEN_LIZARD_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_CHICKEN_UNDEAD_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_CHICKEN_MYSTERY_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_EVILCHICKEN] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SWORDCHICK] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_NEWTROOST] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CALF] = BACK_ANIM_H_SLIDE,
    [SPECIES_COW] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SUPER_COW] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_COW_DAIRY_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_COW_UNDEAD_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_COW_CHOCOLATE_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_COW_STRAWBERRY_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_COW_VANILLA_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_COW_HARLEQUIN_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_SKELETALOX_FEMALE_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_BULL] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_BULL_ELDER_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SKELETALOX_MALE_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_TROJAN_COW] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_COW_PLAGUE_FORM] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_MINOTAUR_NORMAL_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_MINOTAUR_RUNE_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_UNICOW] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_RAT_NORMAL_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_GIANT_RAT_NORMAL_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_BRINE_RAT] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_GIANT_RAT_BLESSED_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_RAT_HELL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GIANT_RAT_HELL_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SHELL_RAT] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_RAT_CRYPT_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_GIANT_RAT_CRYPT_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WARPED_RAT] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_ZOMBIE_RAT] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_GIANT_RAT_DUNGEON_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_RAT_KING_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_GIANT_RAT_KING_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ALBINO_RAT] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_ANGRY_RAT] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_EXPERIMENT_2_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_LAMB] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_SHEEP_WHITE_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_SHEEP_PLAGUE_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_SHEEP_BLACK_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_RAM_FLUFFY_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_RAM_SHAGGY_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_RAM_GOLDEN_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SHEEP_PIRATE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_GOAT_BILLY_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_GOAT_DESERT_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_GOAT_MOUNTAIN_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GORAK] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_SARDINE] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_HERRING] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_TROUT_NORMAL_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SWORDFISH] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_TROUT_LEAPING_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_STURGEON] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_TROUT_TROPICAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SAILFISH] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_THALLASUS] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BASS] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SALMON_NORMAL_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SHARK_NORMAL_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_FURY_SHARK] = BACK_ANIM_GROW_1,
    [SPECIES_SALMON_LEAPING_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_SHARK_GREATWHITE_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SHARK_TIGER_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_MACKEREL] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_CATFISH] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SHARK_BARON_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_TARPON] = BACK_ANIM_GROW_1,
    [SPECIES_SEERFISH] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_DESERTSOLE] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_SILLAGO] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_WOBBEGONG] = BACK_ANIM_GROW_1,
    [SPECIES_KARAMBWANJ] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_KARAMBWAN] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_WHITEFISH] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_BELTFISH] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_MANTA_RAY] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_COD] = BACK_ANIM_H_SLIDE,
    [SPECIES_RAINBOW] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SHARK_GOLDEN_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_PIKE] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_MONKFISH_NORMAL_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_ANGLERFISH] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_GIANT_CARP] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_MONKFISH_FRESH_FORM] = BACK_ANIM_H_SLIDE,
    [SPECIES_MONKFISH_GOLDEN_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_GOBLINFISH] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_PET_FISH] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_GILBERT] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_CAVEFISH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_ROCKTAIL] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_EEL_SLIMY_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_EEL_CAVE_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_EEL_SACRED_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_EEL_LAVA_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_EEL_INFERNAL_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_EEL_MOTTLED_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_EEL_SHORT_FINNED_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_EEL_SALVE_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_EEL_DUSK_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_CAVE_MORAY] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_VILE_FISH] = BACK_ANIM_H_SLIDE,
    [SPECIES_PIGLET] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_PIG] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_PIGZILLA] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_PUPPY_PUP_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_PUPPY_MUTT_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_TERRIER] = BACK_ANIM_GROW_1,
    [SPECIES_SHEEPDOG] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_DALMATIAN] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_GREYHOUND] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BULLDOG] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_LABRADOR] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_CORGI] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_TERROR_DOG] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_STRAY_DOG] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_MUNCHER] = BACK_ANIM_GROW_1,
    [SPECIES_HELLPUPPY] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_HELLHOUND] = BACK_ANIM_GROW_1,
    [SPECIES_CERBERUS] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_KITTEN] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CAT_NORMAL_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_CAT_OVERGROWN_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CAT_LAZY_FORM] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CAT_WILY_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CAT_PURPLE_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_CAT_HELL_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_CAT_POST_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_CAT_SUNKEN_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_BOB] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_EVIL_BOB] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_PET_ROCK] = BACK_ANIM_NONE,
    [SPECIES_ROCK_POLISHED_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_PILLAR] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_ROCK_SOUP] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_SLAGILITH] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_ROCK_STRANGE_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_ROCK_GOLDEN_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_2,
    [SPECIES_PARTY_ROCK] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_STRYKEWYRM_FREEZY_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_STRYKEWYRM_LEAFY_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_STRYKEWYRM_SANDY_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_STRYKEWYRM_WILDY_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SCORPLING] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SCORPION_NORMAL_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_SCORPION_PIT_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_SCORPION_POISON_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SCORPION_KING_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SCORPION_GRAVE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SCORPION_CORRUPTED_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SCORPION_REANIMATED_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_SCORPION_GAUNTLET_CRYSTALLINE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_SCORPION_GAUNTLET_CORRUPTED_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_SCORPION_KHAZARD_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SCORPION_SPIRIT_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SCORPIA] = BACK_ANIM_GROW_1,
    [SPECIES_DREADNIP] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_PEEPLING] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SNEAKRPEEP] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_RUNTSTABLE] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BASILISK] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_BABY_MOLE] = BACK_ANIM_GROW_1,
    [SPECIES_GIANT_MOLE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SQUIRREL] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_RAVENLING] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_RAVEN_NORMAL_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_RAVEN_NEVERMORE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_RAVEN_SPOOKY_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_RAVEN_CRYSTAL_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CROW] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_MAGPIE] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CHINCHOMPA_GREY_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_CHINCHOMPA_RED_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_CHINCHOMPA_GOLD_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_VULTLING] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_VULTURE] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_PENGLING] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_PENGUIN] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_PENGUIN_CLOCKWORK_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_THE_THING] = BACK_ANIM_H_SLIDE,
    [SPECIES_PING] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_PONG] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_PENGUIN_MCGRAW_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_PENGUIN_SPY_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_PENGUIN_AGENT_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_PENGUIN_DISGUISE_CACTUS_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_PENGUIN_DISGUISE_ROCK_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_PENGUIN_DISGUISE_BUSH_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_PENGUIN_DISGUISE_BOX_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_EXEXPARROT] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BROAV] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_TOOTHS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_RUNE_GUARDIAN] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_GNOMEY] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_SPARKLES] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_BAT] = BACK_ANIM_H_SLIDE,
    [SPECIES_GIANT_BAT] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WARPED_BAT] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_ALBINO_BAT] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_BAT_BOX_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_FRUIT_BAT] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_VAMPYREBAT] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DEATHWING] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SHAIKAH] = BACK_ANIM_GROW_1,
    [SPECIES_GROWLER] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_PHOENLING_REBIRTH_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_PHOENLING_REBORN_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_PHOENIX_REBIRTH_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_PHOENIX_REBORN_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_PLANT_STRANGE_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_PLANT_STRANGER_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_EVILTURNIP] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_CREATURE_CUTE_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_CREATURE_EVIL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BABY_YAK] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_YAK_NORMAL_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_YAK_PACK_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_YAK_SACRED_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_YAK_CLUESCROLL_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_YAK_UNDEAD_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_YAK_SNACK_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_MINITRICE] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_COCKATRICE] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_GUTHATRICE] = BACK_ANIM_GROW_1,
    [SPECIES_ZAMATRICE] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SARATRICE] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CORXATRICE] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_VULATRICE] = BACK_ANIM_H_SLIDE,
    [SPECIES_PENGATRICE] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CHOCATRICE] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SPROUTLING_SUMMER_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SPROUTLING_SPRING_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_SPROUTLING_WINTER_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_SPROUTLING_AUTUMN_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_RUE] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_MONTY] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_ZYGOMITE] = BACK_ANIM_GROW_1,
    [SPECIES_ABYSSALING] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ABYSSAL_MINION_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ABYSSAL_DEMON_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_ABYSSAL_SIRE_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_ABYSSAL_LEECH_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_ABYSSAL_PARASITE_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_ABYSSAL_LURKER_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_ABYSSAL_WALKER_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_ABYSSAL_TITAN_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TZ_KIH] = BACK_ANIM_H_SLIDE,
    [SPECIES_TZ_KEK] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TOK_XIL] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TZ_KIH_SPIRIT_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_KET_DILL] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_KET_ZEK] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_YT_HURKOT] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_YT_MEJKOT] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TZREK_JAD] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TZTOK_JAD] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JALTOK_JAD] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JAL_MEJRAH] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JAL_AK] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JAL_XIL] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JAL_NIB] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JAL_IMKOT] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_JAL_ZEK] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TZKAL_ZUK] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DUCKLING] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SWAN] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_DUCK_NORMAL_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MEGA_DUCK] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_DUCK_CART_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_PLATYPODE] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_PLATYPUS] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_FLEDGLING] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DAGANNOTH_NORMAL_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_DAGANNOTH_GUARDIAN_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_DAGANNOTH_KING_RANGE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DAGANNOTH_KING_MAGIC_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_DAGANNOTH_KING_MELEE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_DAGANNOTH_KING_RANGE_MEGA_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DAGANNOTH_KING_MAGIC_MEGA_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_DAGANNOTH_KING_MELEE_MEGA_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_CHAOS_ELE] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CHAOS_ELE_MEGA_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_BANDLING] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BANDBIRD] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BANDEAGLE] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_ZAROLING] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_ZAROBIRD] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ZARAVEN] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SERELING] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_SEREBIRD] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_SEREPEA] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_FROGSPAWN] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_FROG_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_GIANT_FROG_NORMAL_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_GIANT_FROG_ROYAL_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_FROG_BLOATED_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_FROG_BALLOON_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_TOAD_BARKER_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_FROGEEL] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_SPIDERLING] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SPIDER_GIANT_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_SPIDER_DEADLYRED_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SPIDER_JUNGLE_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_SPIDER_BLESSED_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_SPIDER_HUGE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SPIDER_NIGHT_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SPIDER_ICE_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_SPIDER_SPIRIT_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_EEK] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_MINSTRLWEB] = BACK_ANIM_GROW_2,
    [SPECIES_SARACHNIS] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_VENENATIS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_SPIDINE] = BACK_ANIM_H_SLIDE,
    [SPECIES_CRAYFISH] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SHRIMP] = BACK_ANIM_H_SLIDE,
    [SPECIES_LOBSTER_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LOBSTER_GOLDEN_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_LOBSTER_GIANT_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_LOBSTER_HEIM_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_LOBSTER_OBSIDIAN_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_CRAB_RED_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_GIANT_CRAB_RED_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CRAB_MOSS_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GIANT_CRAB_MOSS_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CRAB_RUMPUMPED_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_GIANT_CRAB_RUMPUMPED_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_CRAB_DARK_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_GIANT_CRAB_DARK_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_CRAB_GREY_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_GIANT_CRAB_GREY_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_KNIFE_CRAB] = BACK_ANIM_GROW_1,
    [SPECIES_HEIM_CRAB] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WEBSNIPPER] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BLUE_CRAB] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CRABLET_FIRST_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_CRABLET_SECOND_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_CRABLET_THIRD_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_CRABLET_FORTH_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_CRABLET_FIFTH_FORM] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_CRAWLER_CAVE_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CRAWLER_CHASM_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_CRAWLER_MONSTROUS_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_WINSTON] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_TORTOISE_NORMAL_FORM] = BACK_ANIM_H_SLIDE,
    [SPECIES_TORTOISE_WARPED_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_TORTOISE_WAR_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_VALLUTA] = BACK_ANIM_GROW_2,
    [SPECIES_SEA_TURTLE] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_SEA_TURTLE_TREASURE_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_HERBERT] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_XINACHTO] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_CAVE_SLIME] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_JELLY_NORMAL_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_JELLY_WARPED_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_JELLY_SPIRIT_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_ABBYSPECTR] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SALAMANDER_GREEN_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_SALAMANDER_ORANGE_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SALAMANDER_RED_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SALAMANDER_BLACK_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SALAMANDER_AUGMENTED_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_GECKO] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_CHAMELEON] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_BLOODVELD] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BLOODVELD_INSATIABLE_PHYSICAL_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_BLOODVELD_INSATIABLE_SPECIAL_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_BLOODVELD_MUTATED_PHYSICAL_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_BLOODVELD_MUTATED_SPECIAL_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_REAVER] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ARMALING] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_ARMABIRD] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_ARMAFALCON] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_UNGODLING] = BACK_ANIM_GROW_1,
    [SPECIES_UNGODBIRD] = BACK_ANIM_GROW_1,
    [SPECIES_UNGODGEON] = BACK_ANIM_GROW_1,
    [SPECIES_TUMEKLING] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_TUMEKBIRD] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_TUMEKIBIS] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_KERRIT] = BACK_ANIM_H_SLIDE,
    [SPECIES_SNUFFLE] = BACK_ANIM_H_SLIDE,
    [SPECIES_POPOCA] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CHOLOA] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_DURZAG] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_YAKAMARU] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_CHOMPY] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_JUBBLY] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_JUBSTER] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_TERRORBIRD_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TERRORBIRD_WARPED_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_TERRORBIRD_SPIRIT_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_WOLF_JUVENILE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_WOLF_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WOLF_FENRIS_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_WOLF_WHITE_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_ROVER] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_WOLF_DIRE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_WOLF_JUNGLE_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_WOLF_SKOLL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_WOLF_DESERT_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_WOLF_HATI_HATI] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_WOLF_SPIRIT_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_FOX] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_INARI] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_HELWYR] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_BIRD_NEST] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_BIRDS_NEST_GOD_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_PIGEON] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_PHEASANT] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_ROCLING] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_ROC] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_FOAL] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_UNICORN_WHITE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_UNICORN_STALLION_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_UNICORN_BLACK_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_UNICORN_ANGRY_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_UNICORN_REANIMATED_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_STARLIGHT] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_PAWYA] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_GRENWALL] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_BEAR_CUB] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_BEAR_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BEAR_REANIMATED_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_BEAR_GAUNTLET_CRYSTALLINE_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_CALLISTO] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_POLAR_BEAR_NORMAL_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_POLAR_BEAR_PBJ_AGENT_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_POLAR_BEAR_ARCTIC_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_POLAR_BEAR_NANUQ_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_BEAR_GRIZZLY_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KENDALL] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BEAR_GAUNTLET_CORRUPTED_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_BEAR_ANGRY_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_GRAAHK_NORMAL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GRAAHK_SPIRIT_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_DUST_DEVIL] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SMOKEDEVIL] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SMOKEDEVIL_NUCLEAR_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_CHOKEDEVIL] = BACK_ANIM_GROW_1,
    [SPECIES_SMOKEDEVIL_THERMONUCLEAR_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_HATCHLING] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_DRAGONLING_GREEN_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_DRAGON_GREEN_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_DRAGON_BRUTAL_GREEN_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DRAGONLING_BLUE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_DRAGON_BLUE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DRAGON_BRUTAL_BLUE_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_DRAGONLING_RED_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DRAGON_RED_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DRAGON_BRUTAL_RED_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DRAGONLING_BLACK_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_DRAGON_BLACK_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_DRAGON_BRUTAL_BLACK_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_DRAGON_THREEHEADED_FORM] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_ELVARG] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DRAGON_KING_BLACK_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_DRAGON_QUEEN_BLACK_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_HAND_CREEPING_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_HAND_CRAWLING_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_HAND_SKELETAL_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_HAND_CRUSHING_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_HAND_ZOMBIE_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_TUROTH] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TUROTH_MIGHTIEST_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BIG_TUROTH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SOCKROTH] = BACK_ANIM_H_SLIDE,
    [SPECIES_LILRASK] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_KURASK] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_KURASK_KING_FORM] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_KURASK_OVERLORD_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_KEBBIT] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_KEBBIT_POLAR_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_KEBBIT_SABRE_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_KEBBIT_SPOTTED_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_KEBBIT_DARK_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KEBBIT_DASHING_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KEBBIT_WILD_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_KEBBIT_PRICKLY_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_KEBBIT_RAZOR_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_KEBBIT_BIG_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_KEBBIT_DESERTDEVIL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KEBBIT_FELDIP_WEASEL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_KEBBIT_BARBED_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    ...
    [SPECIES_GORILLA_NORMAL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_MONKEY_ZOMBIE_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_GORILLA_ANCIENT_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_MONKEY_HARMLESS_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_MONKEY_GHOST_FORM] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_GORILLA_AYUNI_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_GORILLA_LEEUNI_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GORILLA_ERUNI_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_MONKEY_KARAMJA_BABY_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_MONKEY_KARAMJA_ADULT_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_LARUPIA_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LARUPIA_SPIRIT_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_KYATT_NORMAL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_KYATT_SPIRIT_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_CRABLING] = BACK_ANIM_H_SLIDE,
    [SPECIES_ROCK_CRAB_NORMAL_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_ROCK_CRAB_GIANT_NORMAL_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_ROCK_CRAB_AMMONITE_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_ROCK_CRAB_GIANT_AMMONITE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_ROCK_CRAB_SAND_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_ROCK_CRAB_GIANT_SAND_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_ROCK_CRAB_SWAMP_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_ROCK_CRAB_GIANT_SWAMP_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CRAB_GRANITE_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_LOBSTER_GRANITE_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_LOBSTER_ROCK_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_RABBIT] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_WOLPERTING] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_BUNYIP] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_TALONBEAST_TALON_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TALONBEAST_NAIL_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_FERRET] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_TOY_MOUSE] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_TOY_DOLL] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_TOY_SOLDIER] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_CAT_CLOCKWORK_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_MAGICARPET] = BACK_ANIM_GROW_1,
    [SPECIES_ANICHAIR] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_EXORAXE] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_SPOOKAXE] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DOBBIN] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_MARIONETTE] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DRAGONKITE] = BACK_ANIM_H_SLIDE,
    [SPECIES_ANIMOUR] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DEAD_TREE] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_JADINKO] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_KILLERWATT] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_MACKERS] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TURKEY_FEMALE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_TURKEY_MALE_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_TURKEY_PROTESTOR_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TOUCAN_TENACIOUS_MALE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_TOUCAN_TENACIOUS_FEMALE_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_TOUCAN_TUAI_LEIT_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_JELLYFISH_BLUBBER_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_JELLYFISH] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_PURE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_RUNE] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_ESSENCE] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_SEAGULL_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_PELICAN] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ALBATROSS] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SEAGULL_HATTENKRAPPER_FORM] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SEAGULL_KOPPENPLOPPEN_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_SEAGULL_STEVEN_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_IBIS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_DESERTWYRM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_WYRM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_SNAKE_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_COBRA_NORMAL_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_COBRA_SPIRIT_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_JUNA] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_SNAKE_SEA_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_BIG_SNAKE_SEA_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_THINGUMWUT] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_EXPERIMENT_3_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_CABBAGE] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_UGHTANKI] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_CAMEL] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CAMEL_WARRIOR_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_BALANCEELE] = BACK_ANIM_GROW_2,
    [SPECIES_KALPHITE_LARVA_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_KALPHITE_WORKER_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_KALPHITE_SOLDIER_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KALPHITE_SPIRIT_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_KALPHITE_GUARDIAN_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_KALPHITE_QUEEN_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_KALPHITE_QUEEN_MEGA_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_KALPHITE_PARAGON_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_KALPHITE_CORRUPTED_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_KALPHITE_MARAUDER_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_KALPHITE_KING_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KALPHITE_DUNG_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_KALPHITE_REANIMATED_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_ABYSSAL_DEMON_REANIMATED_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_BAT_GAUNTLET_CORRUPTED_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_BAT_GAUNTLET_CRYSTALLINE_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_BLOODVELD_REANIMATED_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_DARK_BEAST_GAUNTLET_CORRUPTED_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_DARK_BEAST_GAUNTLET_CRYSTALLINE_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DARK_BEAST_PUP_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_DARK_BEAST_NORMAL_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DARK_BEAST_SOTETSEG_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_EXPERIMENT_4_FORM] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_EXPERIMENT_5_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_GANODERMIC_BEAST] = BACK_ANIM_GROW_1,
    [SPECIES_GRIFOLAPINE] = BACK_ANIM_GROW_1,
    [SPECIES_GRIFOLAROO] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SPORAXE] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_HEADLESS_BEAST] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BEHEMOTH_NORMAL_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BEHEMOTH_ADOLSCENT_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SIEGE_BEAST] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_BULWARK_BEAST] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_BEHEMOTH_GLUTTONOUS_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_BEHEMOTH_RUNEBOUND_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_STOMP] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_HOPE_DEVOURER] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_KARAMTHULU_OVERLORD] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_LIGHT_CREATURE] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_MINOTAUR_REANIMATED_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_MONKEY_REANIMATED_FORM] = BACK_ANIM_H_SLIDE,
    [SPECIES_RAT_GAUNTLET_CORRUPTED_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_RAT_GAUNTLET_CRYSTALLINE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_RAT_FUNGAL_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_SPARKY] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_SPIDER_CORPSE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SPIDER_FEVER_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_SPIDER_LAVA_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SPIDER_SHADOW_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_STALKER] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SOULSEEKER] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_STALKER_SENTINEL_FORM] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_NIGHT_GAZER] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_PLANE_FREEZER] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_WORLD_GORGER] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_FLESH_MONGER] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_SHADOW_FORGER] = BACK_ANIM_GROW_1,
    [SPECIES_VEIL_RIPPER] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_UNICORN_GAUNTLET_CORRUPTED_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_UNICORN_GAUNTLET_CRYSTALLINE_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_WOLF_CAVE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_WOLF_DRAGON_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_SHADOW_HOUND] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_BORDER_COLLIE] = BACK_ANIM_FADE_GREEN_WITH_SHAKE,
    [SPECIES_BLOODHOUND] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GUARD_DOG] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LYCURGUS] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_YAK_MOORRISSEY_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_YAK_ROBIN_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_YAK_YAKTRICK_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CABBAGE_SISTER_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CABBAGE_CRISPY_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_STRYKEWYRM_MINI_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_CROCODILE_NORMAL_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CROCODILE_MUTADILE_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_CROCODILE_ANKH_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_CROCODILE_UKUNDUKA_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_BLOODVELD_INSATIABLE_MUTATED_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_BLOODVELD_ACIDIC_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_BLOODVELD_VAMPIRIC_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_BLOODVELD_RS3_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_BEAVER] = BACK_ANIM_H_SLIDE,
    [SPECIES_GIANT_BEAVER] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_RACOON] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_RALPH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_ROCKY] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_HONEY_BADGER] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SQUIRREL_GIANT_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_SQUIRREL_AUSTRALIAN_FORM] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_JADE_VINE] = BACK_ANIM_GROW_1,
    [SPECIES_KLIK] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_JACKALOPE] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_IMP] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DEMON_LESSER_RS3_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_DEMON_GREATER_RS3_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_DEMON_KALGERION_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DEMON_THUNDEREOUS_FORM] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_DEMON_RIPPER_FORM] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_DEMON_LESSER_OSRS_FORM] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DEMON_GREATER_OSRS_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DEMON_TSTANON_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_DEMON_TORMENTED_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DELRITH] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_DEMON_LESSER_TONGUE_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DEMON_GREATER_TONGUE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_DEMON_ZAKLN_FORM] = BACK_ANIM_GROW_2,
    [SPECIES_DEMON_PUMMELER_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_DEMON_CHOCOLATE_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DEMON_LESSER_BLACK_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_DEMON_GREATER_BLACK_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DEMON_BALFRUG_FORM] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_DEMON_JUNGLE_FORM] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_DEMON_RIFTSPLITTER_FORM] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_SNOW_IMP] = BACK_ANIM_CIRCLE_MOVE_COUNTERCLOCKWISE,
    [SPECIES_DEMON_ICE_OSRS_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_DEMON_ICE_RS3_FORM] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_DEMON_BLOODCHILLER_FORM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_DEMON_REANIMATED_FORM] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_KRIL_TSUTSAROTH] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_PYREFIEND] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_PYRELORD] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_WATERFIEND] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_WATERLORD] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_ICEFIEND] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_ICELORD] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    [SPECIES_IMPLING_BABY_FORM] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_IMPLING_MAGPIE_FORM] = BACK_ANIM_GROW_1,
    [SPECIES_IMPLING_DRAGON_FORM] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_IMPLING_KINGLY_FORM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
