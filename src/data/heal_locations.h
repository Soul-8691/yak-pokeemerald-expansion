static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CATACOMBS_OF_KOUREND - 1] = {MAP_GROUP(KOUREND_CATACOMBS1), MAP_NUM(KOUREND_CATACOMBS1), 21, 10},
    [HEAL_LOCATION_GRAND_EXCHANGE_INDOORS - 1] = {MAP_GROUP(GRAND_EXCHANGE_INDOORS), MAP_NUM(GRAND_EXCHANGE_INDOORS), 9, 13},
};
