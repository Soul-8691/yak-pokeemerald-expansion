...
//pokescape crops
const struct SpriteFrameImage sPicTable_CabbageCrop[] = {
    overworld_frame(gObjectEventPic_BerryTreeDirtPile, 2, 2, 0),
    overworld_frame(gObjectEventPic_BerryTreeSprout, 2, 2, 0),
    overworld_frame(gObjectEventPic_BerryTreeSprout, 2, 2, 1),
...
const u16 gBerryTreePaletteTagTable_Cabbage[] = {OBJ_EVENT_PAL_TAG_NPC_2, OBJ_EVENT_PAL_TAG_NPC_3, OBJ_EVENT_PAL_CABBAGE_CROP, OBJ_EVENT_PAL_CABBAGE_CROP, OBJ_EVENT_PAL_CABBAGE_CROP};
...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_CABBAGE_FARMING - FIRST_BERRY_INDEX] = sPicTable_CabbageCrop,
...
const u16 *const gBerryTreeObjectEventGraphicsIdTablePointers[] = {
    ...
    // 3 unused berries.
    // removed to save on item IDs - PippinSmith
