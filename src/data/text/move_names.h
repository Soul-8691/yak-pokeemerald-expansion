...
// Gigantamax Moves
    ...
    [MOVE_SLAYERS_STAFF] = _("SlayerStaff"),
    [MOVE_LEAF_BLADED_SWORD] = _("LBSword"),
    [MOVE_LEAF_BLADED_SPEAR] = _("LBSpear"),
    [MOVE_LEAF_BLADED_BATTLEAXE] = _("LBBattleaxe"),
    [MOVE_ABYSSAL_WHIP] = _("Abby Whip"),
    [MOVE_PROTECT_FROM_MAGIC] = _("MagProtect"),
    [MOVE_PROTECT_FROM_MELEE] = _("MeleeProtect"),
    [MOVE_PROTECT_FROM_MISSILES] = _("MisslProtect"),
    [MOVE_ANCIENT_STAFF] = _("AncientStaff"),
    [MOVE_TOXIC_BLOWPIPE] = _("Toxic Darts"),
    [MOVE_MAGIC_SHORTBOW] = _("Magic Bow"),
    [MOVE_PIETY] = _("Piety"),
    [MOVE_RIGOUR] = _("Rigour"),
    [MOVE_AUGURY] = _("Augury"),
    [MOVE_IBANS_STAFF] = _("Iban Blast"),
    [MOVE_WATER_SURGE] = _("Water Surge"),
    [MOVE_FIRE_SURGE] = _("Fire Surge"),
    [MOVE_WIND_SURGE] = _("Wind Surge"),
    [MOVE_EARTH_SURGE] = _("Earth Surge"),
    [MOVE_SMOKE_BARRAGE] = _("Smoke Barr"),
    [MOVE_SHADOW_BARRAGE] = _("Shadow Barr"),
    [MOVE_BLOOD_BARRAGE] = _("Blood Barr"),
    [MOVE_ICE_BARRAGE] = _("Ice Barr"),
    [MOVE_ABYSSAL_DAGGER] = _("Abby Dagger"),
    [MOVE_DRAGON_SCIMITAR] = _("Dragon Scim"),
    [MOVE_ZAMORAKIAN_HASTA] = _("Zamor Hasta"),
    [MOVE_TWISTED_BOW] = _("Twisted Bow"),
    [MOVE_DRAGON_CROSSBOW] = _("Dragon CBow"),
};
#endif
