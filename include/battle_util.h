...
#define ABILITYEFFECT_PETRIFY1                   15
#define ABILITYEFFECT_PETRIFY2                   16
#define ABILITYEFFECT_NEUTRALIZINGGAS            17
#define ABILITYEFFECT_FIELD_SPORT                18 // Only used if B_SPORT_TURNS < GEN_6
// Special cases
...
#define ITEMEFFECT_KARIL                        4
#define ITEMEFFECT_KINGSROCK                    5
#define ITEMEFFECT_TARGET                       6
#define ITEMEFFECT_ORBS                         7
#define ITEMEFFECT_LIFEORB_SHELLBELL            8
#define ITEMEFFECT_BATTLER_MOVE_END             9 // move end effects for just the battler, not whole field
