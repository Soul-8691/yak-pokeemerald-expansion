...
$(OBJEVENTGFXDIR)/pokemon/species/rillaboom.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/pokemon/species/duraludon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/pokemon/species/grimmsnarl.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
