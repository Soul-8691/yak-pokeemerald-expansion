...
#define VALENCIA_PARK_TRAINER_COUNT 3
...
{
    u8 i;
    u16 vars[VALENCIA_PARK_TRAINER_COUNT] = {VAR_VALENCIA_PARK_TRAINER_1, VAR_VALENCIA_PARK_TRAINER_2, VAR_VALENCIA_PARK_GRAFAIAI};
    u16 flags[VALENCIA_PARK_TRAINER_COUNT] = {TRAINER_FLAGS_START + TRAINER_VALENCIA_PARK_1, TRAINER_FLAGS_START + TRAINER_VALENCIA_PARK_2, FLAG_VALENCIA_PARK_GRAFAIAI};
