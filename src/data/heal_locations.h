static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GRAND_EXCHANGE - 1] = {MAP_GROUP(GRAND_EXCHANGE), MAP_NUM(GRAND_EXCHANGE), 5, 16},
    ...
    [HEAL_LOCATION_NEITIZNOT - 1] = {MAP_GROUP(NEITIZNOT), MAP_NUM(NEITIZNOT), 21, 23},
    [HEAL_LOCATION_JATIZSO - 1] = {MAP_GROUP(JATIZSO), MAP_NUM(JATIZSO), 10, 10},
};
