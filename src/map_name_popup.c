...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    //pokescape
    [MAPSEC_MISTHALIN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TUTORIAL_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LUMBRIDGE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_DRAYNOR] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PORT_SARIM] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FALADOR] = MAPPOPUP_THEME_STONE,
    [MAPSEC_RIMMINGTON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VARROCK] = MAPPOPUP_THEME_STONE2,
};
