...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ProfIvy = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_PROF_IVY,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 16,
    .height = 32,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = gObjectEventPicTable_ProfIvy,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Skwovet = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_SKWOVET,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Blipbug = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_BLIPBUG,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Sewaddle = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_SEWADDLE,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Shroodle = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_SHROODLE,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Joltik = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_JOLTIK,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Pancham = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_PANCHAM,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Grafaiai = { 
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_GRAFAIAI,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
