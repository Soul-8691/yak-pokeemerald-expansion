static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VARROCK_NORTH - 1] = {MAP_GROUP(VARROCK_NORTH), MAP_NUM(VARROCK_NORTH), 3, 9},
    [HEAL_LOCATION_BARBARIAN_VILLAGE - 1] = {MAP_GROUP(BARBARIAN_VILLAGE), MAP_NUM(BARBARIAN_VILLAGE), 16, 27},
