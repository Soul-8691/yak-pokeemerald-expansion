...
static void FillTrainerParty(u16 trainerId, u8 firstMonId, u8 monCount)
{
    ...
    while (i != monCount)
    {
        ...
        if ((level == FRONTIER_MAX_LEVEL_50 || level == 20) && monId > FRONTIER_MONS_POKESCAPE_END)
            continue;
...
u16 GetRandomFrontierMonFromSet(u16 trainerId)
{
    ...
    } while((level == FRONTIER_MAX_LEVEL_50 || level == 20) && monId > FRONTIER_MONS_POKESCAPE_END);
