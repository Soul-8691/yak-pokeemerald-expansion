...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_ASH_WALK_RUN,             OBJ_EVENT_GFX_RIVAL_MAY_NORMAL},
...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_ASH_WALK_RUN,     OBJ_EVENT_GFX_MAY_NORMAL},
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_ASH_WALK_RUN,     PLAYER_AVATAR_FLAG_ON_FOOT},
...
static bool32 CheckTileQualification(s16 tile[], s16 player[], u32 facingDirection, struct ObjectEvent* objectEvent, bool32 isTileLand[], u32 direction)
{
    ...
    if (IsPlayerHere(tile[AXIS_X], tile[AXIS_Y], player[AXIS_X], player[AXIS_Y]))
        ...
        return TRUE;
    else if (MetatileBehavior_IsSurfableWaterOrUnderwater(MapGridGetMetatileBehaviorAt(tile[AXIS_X], tile[AXIS_Y])))
        return FALSE;
