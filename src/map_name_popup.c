...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	//pokescape
	[MAPSEC_MISTHALIN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_KHARIDIAN_DESERT] = MAPPOPUP_THEME_STONE2,
	[MAPSEC_ASGARNIA] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_FELDIP_HILLS] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_FREMENNIK_PROVINCE] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_KANDARIN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_KARAMJA] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_MORYTANIA] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_WILDERNESS] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_TUTORIAL_ISLAND] = MAPPOPUP_THEME_WOOD,
