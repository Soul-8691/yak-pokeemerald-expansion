...
const u16 gMetatileAttributes_OrangeIslandsPrimary[] = INCBIN_U16("data/tilesets/primary/orange_islands_primary/metatile_attributes.bin");

const u16 gMetatiles_ValenciaIslandSecondary[] = INCBIN_U16("data/tilesets/secondary/valencia_island_secondary/metatiles.bin");
const u16 gMetatileAttributes_ValenciaIslandSecondary[] = INCBIN_U16("data/tilesets/secondary/valencia_island_secondary/metatile_attributes.bin");
