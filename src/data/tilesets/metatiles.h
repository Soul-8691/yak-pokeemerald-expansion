...
const u16 gMetatiles_OrangeIslandsExterior[] = INCBIN_U16("data/tilesets/primary/orange_islands_exterior/metatiles.bin");
const u16 gMetatileAttributes_OrangeIslandsExterior[] = INCBIN_U16("data/tilesets/primary/orange_islands_exterior/metatile_attributes.bin");
