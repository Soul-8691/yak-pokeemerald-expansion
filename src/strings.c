...
const u8 gText_SideQuestName_5[] = _("Bloodvelds");
const u8 gText_SideQuestName_6[] = _("Brutal Black Dragons");
const u8 gText_SideQuestName_7[] = _("Brutal Blue Dragons");
const u8 gText_SideQuestName_8[] = _("Brutal Red Dragons");
const u8 gText_SideQuestName_9[] = _("Fire Giants");
const u8 gText_SideQuestName_10[] = _("Hellhounds");
const u8 gText_SideQuestName_11[] = _("Iron Dragons");
const u8 gText_SideQuestName_12[] = _("Steel Dragons");
const u8 gText_SideQuestName_13[] = _("Ankou");
const u8 gText_SideQuestName_14[] = _("Spectres");
const u8 gText_SideQuestName_15[] = _("Dagannoth");
const u8 gText_SideQuestName_16[] = _("Dust Devils");
...
const u8 gText_SideQuestDesc_5[] = _("Slay {STR_VAR_3} Bloodveld(s).");
const u8 gText_SideQuestDesc_6[] = _("Slay {STR_VAR_3} Brutal Black Dragon(s).");
const u8 gText_SideQuestDesc_7[] = _("Slay {STR_VAR_3} Brutal Blue Dragon(s).");
const u8 gText_SideQuestDesc_8[] = _("Slay {STR_VAR_3} Brutal Red Dragon(s).");
const u8 gText_SideQuestDesc_9[] = _("Slay {STR_VAR_3} Fire Giant(s).");
const u8 gText_SideQuestDesc_10[] = _("Slay {STR_VAR_3} Hellhound(s).");
const u8 gText_SideQuestDesc_11[] = _("Slay {STR_VAR_3} Iron Dragon(s).");
const u8 gText_SideQuestDesc_12[] = _("Slay {STR_VAR_3} Steel Dragon(s).");
const u8 gText_SideQuestDesc_13[] = _("Slay {STR_VAR_3} Ankou.");
const u8 gText_SideQuestDesc_14[] = _("Slay {STR_VAR_3} Spectre(s).");
const u8 gText_SideQuestDesc_15[] = _("Slay {STR_VAR_3} Dagannoth.");
const u8 gText_SideQuestDesc_16[] = _("Slay {STR_VAR_3} Dust Devil(s).");
...
const u8 gText_SideQuestDoneDesc_5[] = _("Completed Bloodvelds");
const u8 gText_SideQuestDoneDesc_6[] = _("Completed Brutal Black Dragons");
const u8 gText_SideQuestDoneDesc_7[] = _("Completed Brutal Blue Dragons");
const u8 gText_SideQuestDoneDesc_8[] = _("Completed Brutal Red Dragons");
const u8 gText_SideQuestDoneDesc_9[] = _("Completed Fire Giants");
const u8 gText_SideQuestDoneDesc_10[] = _("Completed Hellhounds");
const u8 gText_SideQuestDoneDesc_11[] = _("Completed Iron Dragons");
const u8 gText_SideQuestDoneDesc_12[] = _("Completed Steel Dragons");
const u8 gText_SideQuestDoneDesc_13[] = _("Completed Ankou");
const u8 gText_SideQuestDoneDesc_14[] = _("Completed Spectres");
const u8 gText_SideQuestDoneDesc_15[] = _("Completed Dagannoth");
const u8 gText_SideQuestDoneDesc_16[] = _("Completed Dust Devils");
...
const u8 gText_SideQuestMap3[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap4[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap5[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap6[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap7[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap8[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap9[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap10[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap11[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap12[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap13[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap14[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap15[] = _("Catacombs of Kourend");
const u8 gText_SideQuestMap16[] = _("Catacombs of Kourend");
...
const u8 gText_AntifirePotion24SP[] = _("Antifire Potion{CLEAR_TO 0x6E}24SP");
const u8 gText_AntiDragonShield36SP[] = _("Anti-Dragon Shield{CLEAR_TO 0x6E}36SP");
const u8 gText_BlackMask48SP[] = _("Black Mask{CLEAR_TO 0x6E}48SP");
const u8 gText_BlessedSet72SP[] = _("Blessed Set{CLEAR_TO 0x6E}72SP");
const u8 gText_BroadArrows24SP[] = _("Broad Arrows{CLEAR_TO 0x6E}24SP");
const u8 gText_BroadBolts24SP[] = _("Broad Bolts{CLEAR_TO 0x6E}24SP");
const u8 gText_EternalBoots36SP[] = _("Eternal Boots{CLEAR_TO 0x6E}36SP");
const u8 gText_FireCape60SP[] = _("Fire Cape{CLEAR_TO 0x6E}60SP");
const u8 gText_GodCape60SP[] = _("God Cape{CLEAR_TO 0x6E}60SP");
const u8 gText_InfernalCape72SP[] = _("Infernal Cape{CLEAR_TO 0x6E}72SP");
const u8 gText_MirrorShield24SP[] = _("Mirror Shield{CLEAR_TO 0x6E}24SP");
const u8 gText_MythicalCape48SP[] = _("Mythical Cape{CLEAR_TO 0x6E}48SP");
const u8 gText_ObsidianSet84SP[] = _("Obsidian Set{CLEAR_TO 0x6E}84SP");
const u8 gText_SalveAmulet60SP[] = _("Salve Amulet{CLEAR_TO 0x6E}60SP");
const u8 gText_SlayerHelmet72SP[] = _("Slayer Helmet{CLEAR_TO 0x6E}72SP");
const u8 gText_AssaultVest60SP[] = _("Assault Vest{CLEAR_TO 0x6E}60SP");
const u8 gText_ChoiceBand84SP[] = _("Choice Band{CLEAR_TO 0x6E}84SP");
const u8 gText_ChoiceScarf84SP[] = _("Choice Scarf{CLEAR_TO 0x6E}84SP");
const u8 gText_ChoiceSpecs84SP[] = _("Choice Specs{CLEAR_TO 0x6E}84SP");
const u8 gText_Eviolite60SP[] = _("Eviolite{CLEAR_TO 0x6E}60SP");
const u8 gText_ExpertBelt48SP[] = _("Expert Belt{CLEAR_TO 0x6E}48SP");
const u8 gText_FocusSash48SP[] = _("Focus Sash{CLEAR_TO 0x6E}48SP");
const u8 gText_HeavyDutyBoots36SP[] = _("Heavy-Duty Boots{CLEAR_TO 0x6E}36SP");
const u8 gText_Leftovers84SP[] = _("Leftovers{CLEAR_TO 0x6E}84SP");
const u8 gText_LifeOrb72SP[] = _("Life Orb{CLEAR_TO 0x6E}72SP");
const u8 gText_LumBerry48SP[] = _("Lum Berry{CLEAR_TO 0x6E}48SP");
const u8 gText_RockyHelmet48SP[] = _("Rocky Helmet{CLEAR_TO 0x6E}48SP");
const u8 gText_SalacBerry36SP[] = _("Salac Berry{CLEAR_TO 0x6E}36SP");
const u8 gText_AirBalloon12SP[] = _("Air Balloon{CLEAR_TO 0x6E}12SP");
const u8 gText_DampRock12SP[] = _("Damp Rock{CLEAR_TO 0x6E}12SP");
const u8 gText_ElectricSeed12SP[] = _("Electric Seed{CLEAR_TO 0x6E}12SP");
const u8 gText_GrassySeed12SP[] = _("Grassy Seed{CLEAR_TO 0x6E}12SP");
const u8 gText_HeatRock12SP[] = _("Heat Rock{CLEAR_TO 0x6E}12SP");
const u8 gText_IcyRock12SP[] = _("Icy Rock{CLEAR_TO 0x6E}12SP");
const u8 gText_LiechiBerry24SP[] = _("Liechi Berry{CLEAR_TO 0x6E}24SP");
const u8 gText_LightClay24SP[] = _("Light Clay{CLEAR_TO 0x6E}24SP");
const u8 gText_MistySeed12SP[] = _("Misty Seed{CLEAR_TO 0x6E}12SP");
const u8 gText_PetayaBerry24SP[] = _("Petaya Berry{CLEAR_TO 0x6E}24SP");
const u8 gText_PsychicSeed12SP[] = _("Psychic Seed{CLEAR_TO 0x6E}12SP");
const u8 gText_SmoothRock12SP[] = _("Smooth Rock{CLEAR_TO 0x6E}12SP");
const u8 gText_TerrainExtender24SP[] = _("Terrain Extender{CLEAR_TO 0x6E}24SP");
const u8 gText_ThroatSpray12SP[] = _("Throat Spray{CLEAR_TO 0x6E}12SP");
const u8 gText_WhiteHerb24SP[] = _("White Herb{CLEAR_TO 0x6E}24SP");

const u8 gText_EnergyBall36SP[] = _("Energy Ball{CLEAR_TO 0x6E}36SP");
const u8 gText_PsychoCut36SP[] = _("Psycho Cut{CLEAR_TO 0x6E}36SP");
const u8 gText_DarkPulse36SP[] = _("Dark Pulse{CLEAR_TO 0x6E}36SP");
const u8 gText_UTurn24SP[] = _("U-Turn{CLEAR_TO 0x6E}24SP");
const u8 gText_Hex24SP[] = _("Hex{CLEAR_TO 0x6E}24SP");
const u8 gText_RazorShell24SP[] = _("Razor Shell{CLEAR_TO 0x6E}24SP");
const u8 gText_SwordsDance72SP[] = _("Swords Dance{CLEAR_TO 0x6E}72SP");
const u8 gText_Hurricane60SP[] = _("Hurricane{CLEAR_TO 0x6E}60SP");
const u8 gText_SteelWing24SP[] = _("Steel Wing{CLEAR_TO 0x6E}24SP");
const u8 gText_LeechLife12SP[] = _("Leech Life{CLEAR_TO 0x6E}12SP");
const u8 gText_Crunch24SP[] = _("Crunch{CLEAR_TO 0x6E}24SP");
const u8 gText_Tailwind24SP[] = _("Tailwind{CLEAR_TO 0x6E}24SP");
const u8 gText_LavaPlume36SP[] = _("Lava Plume{CLEAR_TO 0x6E}36SP");

const u8 gText_SlayersStaff72SP[] = _("Slayer's Staff{CLEAR_TO 0x6E}72SP");
const u8 gText_LeafBladedSword84SP[] = _("Leaf-Bladed Sword{CLEAR_TO 0x6E}84SP");
const u8 gText_LeafBladedSpear84SP[] = _("Leaf-Bladed Spear{CLEAR_TO 0x6E}84SP");
const u8 gText_LeafBladedBattleaxe84SP[] = _("Leaf-Bladed Battleaxe{CLEAR_TO 0x6E}84SP");
const u8 gText_AbyssalWhip72SP[] = _("Abyssal Whip{CLEAR_TO 0x6E}72SP");
const u8 gText_ProtectFromMagic60SP[] = _("Protect From Magic{CLEAR_TO 0x6E}60SP");
const u8 gText_ProtectFromMelee60SP[] = _("Protect From Melee{CLEAR_TO 0x6E}60SP");
const u8 gText_ProtectFromMissiles60SP[] = _("Protect From Missiles{CLEAR_TO 0x6E}60SP");
const u8 gText_AncientStaff72SP[] = _("Ancient Staff{CLEAR_TO 0x6E}72SP");
const u8 gText_ToxicBlowpipe72SP[] = _("Toxic Blowpipe{CLEAR_TO 0x6E}72SP");
const u8 gText_MagicShortbow72SP[] = _("Magic Shortbow{CLEAR_TO 0x6E}72SP");
const u8 gText_Piety72SP[] = _("Piety{CLEAR_TO 0x6E}72SP");
const u8 gText_Rigour72SP[] = _("Rigour{CLEAR_TO 0x6E}72SP");
const u8 gText_Augury72SP[] = _("Augury{CLEAR_TO 0x6E}72SP");
const u8 gText_IbansStaff84SP[] = _("Iban's Staff{CLEAR_TO 0x6E}84SP");
const u8 gText_WaterSurge72SP[] = _("Water Surge{CLEAR_TO 0x6E}72SP");
const u8 gText_FireSurge72SP[] = _("Fire Surge{CLEAR_TO 0x6E}72SP");
const u8 gText_WindSurge72SP[] = _("Wind Surge{CLEAR_TO 0x6E}72SP");
const u8 gText_EarthSurge72SP[] = _("Earth Surge{CLEAR_TO 0x6E}72SP");
const u8 gText_SmokeBarrage84SP[] = _("Smoke Barrage{CLEAR_TO 0x6E}84SP");
const u8 gText_ShadowBarrage84SP[] = _("Shadow Barrage{CLEAR_TO 0x6E}84SP");
const u8 gText_IceBarrage84SP[] = _("Ice Barrage{CLEAR_TO 0x6E}84SP");
const u8 gText_BloodBarrage84SP[] = _("Blood Barrage{CLEAR_TO 0x6E}84SP");
const u8 gText_AbyssalDagger72SP[] = _("Abyssal Dagger{CLEAR_TO 0x6E}72SP");
const u8 gText_DragonScimitar60SP[] = _("Dragon Scimitar{CLEAR_TO 0x6E}60SP");
const u8 gText_ZamorakianHasta84SP[] = _("Zamorakian Hasta{CLEAR_TO 0x6E}84SP");
const u8 gText_TwistedBow96SP[] = _("Twisted Bow{CLEAR_TO 0x6E}96SP");
const u8 gText_DragonCrossbow60SP[] = _("Dragon Crossbow{CLEAR_TO 0x6E}60SP");
