...
// Story Key Items
    ...
    [ITEM_AMULET_OF_STRENGTH] =
    {
        .name = _("Strength Ammy"),
        .price = 0,
        .description = sDummyDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    [ITEM_BLACK_DRAGONHIDE_SET] =
    {
        .name = _("BlckDhide Set"),
        .price = 0,
        .description = sDummyDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    [ITEM_LEAF_BLADED_BATTLEAXE_NOTE] =
    {
        .name = _("LB BAxe"),
        .price = 0,
        .description = sDummyDesc,
    ...
    [ITEM_PROTECT_FROM_MISSILES_NOTE] =
    {
        .name = _("PF Missiles"),
        .price = 0,
        .description = sDummyDesc,
