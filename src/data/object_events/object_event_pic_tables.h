...
const struct SpriteFrameImage sPicTable_AshWalkRun[] = {
   overworld_ascending_frames(gObjectEventPic_AshWalkRun, 2, 4),
};
...
const struct SpriteFrameImage sPicTable_Gary[] = {
