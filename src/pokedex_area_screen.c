...
#define MAP_GROUP_OVERWORLD_MONS MAP_GROUP(ROUTE1)
#define MAP_GROUP_OVERWORLD_MONS_1 MAP_GROUP(LUMBRIDGE)
#define MAP_GROUP_SPECIAL_MONS_1 MAP_GROUP(TUTORIAL_ISLAND_CAVE)
#define MAP_GROUP_SPECIAL_MONS_2 MAP_GROUP(ROUTE1_HOUSE_FRED)
