...
#define QUEST_ARTFIGHT_JATIZSO         2
#define QUEST_4          3
#define QUEST_5          4
#define QUEST_6          5
#define QUEST_7          6
...
#define QUEST_29        28
#define QUEST_30        29
#define QUEST_COUNT     (QUEST_ERNEST_THE_CHICKEN + 1)
...
#define SUB_QUEST_COUNT (QUEST_COOKS_ASSISTANT_SUB_COUNT + QUEST_ARTFIGHT_JATIZSO_SUB_COUNT + QUEST_ARTFIGHT_NEITIZNOT_SUB_COUNT + QUEST_ERNEST_THE_CHICKEN_SUB_COUNT)
