...
static const u8 sText_PkmnGainedEXP[] = _("Your Monster gained EXP. Points!\p");
static const u8 sText_TeamGainedEXP[] = _("Your team gained Exp. Points!\p");
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}DARK WIZARD: You're out of\nPOUCHES! Game over!\p");
...
const u16 gNoEscapeStringIds[] =
{
    ...
    [B_MSG_CANT_RUN_FROM_RAT]    = STRINGID_CANTRUNFROMRAT,
};
...
const u8 gText_SafariZoneMenu[] = _("POUCH{CLEAR_TO 56} \nGO NEAR{CLEAR_TO 56}RUN");
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT DARK_GRAY}POUCHES");
